...
def PlotBGPFit(
    GPy, GPt, Bsearch, d, figsize=(5, 5), height_ratios=[5, 1], colorarray=["darkolivegreen", "peru", "mediumvioletred"]
):
    """
    Plot BGP model
    ...
    for f in range(3):
        ...
        PhiColor = ax.scatter(pt, y, c=d["Phi"][:, gp_num], vmin=0.0, vmax=1, s=40, alpha=0.7)
